      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-4">
              Bringing you premium products with modern design and exceptional quality. Your satisfaction is our
              priority.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {footerLinks.customerService.map((link, index) => (
                <li key={index}>
                  <a href={link.href} className="text-gray-600 hover:text-indigo-600 transition-colors">
                    {link.label}
                  </a>
                </li>
              ))}
        ...
        <div className="border-t border-gray-200 border-opacity-30 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-600 text-sm">&copy; 2024 Hasib's Shop. All rights reserved.</p>
