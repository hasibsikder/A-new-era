  ...
  return (
    <section id="home" className="pt-20 min-h-screen flex items-center relative overflow-hidden">
      <div className="absolute inset-0 opacity-10">
        ...
        <div
          className="absolute bottom-20 right-20 w-48 h-48 glass rounded-full animate-float"
          style={{ animationDelay: "1s" }}
        ></div>
        <div
          className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 glass rounded-full animate-float"
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="text-center lg:text-left">
            ...
            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
              Discover our collection of carefully curated products that blend functionality with exceptional design.
          ...
          <div className="relative">
            ...
            <div
              className="absolute -bottom-4 -left-4 glass w-20 h-20 rounded-2xl flex items-center justify-center animate-float"
